...
class ImageManagerStatic
{
     ...
     * @return \Intervention\Image\Image
     */
    public static function canvas(int $width, int $height, mixed $background = null)
    {
     ...
     * @return mixed
     */
    public static function cache(Closure $callback, ?int $lifetime = null, bool $returnObj = false)
    {
