...
class Image extends File
{
     ...
     * @param mixed  $core
     */
    public function __construct(?AbstractDriver $driver = null, mixed $core = null)
    {
        $this->driver = $driver;
        $this->core = $core;
    }
     ...
     * @return \Intervention\Image\Image
     */
    public function save(?string $path = null, ?int $quality = null, ?string $format = null)
    {
     ...
     * @return mixed
     */
    public function getBackup(?string $name = null)
    {
     ...
     * @return self
     */
    public function setBackup(mixed $resource, ?string $name = null)
    {
        $name = is_null($name) ? 'default' : $name;
